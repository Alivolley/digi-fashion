...
function LatestProducts() {
   ...
   return (
      <div>
         <div className="bg-[#FAF2F04D] px-8 pb-[51px] pt-[58px] customMd:px-[129px] customMd:pb-[94px] customMd:pt-[49px]">
            <div className="mx-auto max-w-[1176px]">
               <div>
                  <div className="flex items-center justify-between">
                     <p className="max-w-[208px] font-jakartaDisplayBold text-base customMd:max-w-[242px] customMd:text-2xl">
                  ...
                  <div className="relative mt-11 customMd:px-[62px]">
                     ...
                     >
                        ...
                        <SwiperSlide>
                           <ProductCart2 image={product8Image} />
                        </SwiperSlide>
                        <SwiperSlide>
                           <ProductCart2 image={product5Image} hasColor />
                        </SwiperSlide>
